    ...
    <div>
      <Geolocation
        render={({
          ...
          while (typeof latitude !== "undefined") {
            ...
            fetch(
              `https://nominatim.openstreetmap.org/reverse?lat=${latitude}&lon=${longitude}&zoom=10&format=json&accept-language=it`,
      ...
      <div className="location">
        ...
        <span className="temperatura">
          {currentDay.temperatura.toString().slice(0, 2)}°C
        </span>
      </div>
